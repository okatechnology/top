...
const SectionLayoutPresentational: VFC<SectionLayoutPresentationalProps> = ({
  ...
  <div className="px-4 pc:px-8 pt-12 pc:pt-16 pb-14 pc:pb-20 min-h-section rounded-2xl bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 transition-colors duration-700 ease-linear grid items-center">
    <div>
