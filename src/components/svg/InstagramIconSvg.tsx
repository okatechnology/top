export const InstagramIconSvg: React.VFC<SvgsProps> = ({ className }) => (
  <svg
    className={`${
      className ? className : ''
    } rounded-full overflow-hidden group-hover:bg-white group-focus:bg-white transition-background-color duration-200`}
    version="1.1"
    id="レイヤー_1"
